...
exec run-c "$0" -lX11
#endif
// From https://github.com/UltimateHackingKeyboard/current-window-linux/blob/master/get-current-window.c
...
int main(int argc, char** argv)
{
    ...
    printf("WM_CLASS: %s\n", get_string_property("WM_CLASS")); // This contains *two* stringz's.
